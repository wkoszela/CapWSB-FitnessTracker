...
class InitialDataLoader {
    ...
    private List<Training> generateTrainingData(List<User> users) {
        ...
        Training training1 = new Training(users.get(0),
                LocalDateTime.parse("2024-01-19T08:00:00"),
                LocalDateTime.parse("2024-01-19T09:30:00"),
                ActivityType.RUNNING,
                10.5,
                8.2);
        Training training2 = new Training(users.get(1),
                LocalDateTime.parse("2024-01-18T15:30:00"),
                LocalDateTime.parse("2024-01-18T17:00:00"),
                ActivityType.CYCLING,
                25.0,
                18.5);
        Training training3 = new Training(users.get(2),
                LocalDateTime.parse("2024-01-17T07:45:00"),
                LocalDateTime.parse("2024-01-17T09:00:00"),
                ActivityType.WALKING,
                5.2,
                5.8);
        Training training4 = new Training(users.get(3),
                LocalDateTime.parse("2024-01-16T18:00:00"),
                LocalDateTime.parse("2024-01-16T19:30:00"),
                ActivityType.RUNNING,
                12.3,
                9.0);
        Training training5 = new Training(users.get(4),
                LocalDateTime.parse("2024-01-15T12:30:00"),
                LocalDateTime.parse("2024-01-15T13:45:00"),
                ActivityType.CYCLING,
                18.7,
                15.3);
        Training training6 = new Training(users.get(5),
                LocalDateTime.parse("2024-01-14T09:00:00"),
                LocalDateTime.parse("2024-01-14T10:15:00"),
                ActivityType.WALKING,
                3.5,
                4.0);
        Training training7 = new Training(users.get(6),
                LocalDateTime.parse("2024-01-13T16:45:00"),
                LocalDateTime.parse("2024-01-13T18:30:00"),
                ActivityType.RUNNING,
                15.0,
                10.8);
        Training training8 = new Training(users.get(7),
                LocalDateTime.parse("2024-01-12T11:30:00"),
                LocalDateTime.parse("2024-01-12T12:45:00"),
                ActivityType.CYCLING,
                22.5,
                17.2);
        Training training9 = new Training(users.get(8),
                LocalDateTime.parse("2024-01-11T07:15:00"),
                LocalDateTime.parse("2024-01-11T08:30:00"),
                ActivityType.WALKING,
                4.2,
                4.5);
        Training training10 = new Training(users.get(9),
                LocalDateTime.parse("2024-01-10T14:00:00"),
                LocalDateTime.parse("2024-01-10T15:15:00"),
                ActivityType.RUNNING,
                11.8,
                8.5);
