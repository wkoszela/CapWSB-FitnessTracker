...
class UserApiIntegrationTest extends IntegrationTestBase {
    ...
    void shouldReturnAllUsersOlderThan_whenGettingAllUsersOlderThan() throws Exception {
        User user1 = existingUser(generateClientWithDate(LocalDate.of(2000, 8, 11)));
        User user2 = existingUser(generateClientWithDate(LocalDate.of(2024, 8, 11)));
    ...
    private static User generateClientWithDate(LocalDate date) {
